        ...
        try:
            ...
            try:
                ...
                if passed >= len(self.thresholds):
                    ...
                    grades.addMessage('FAIL: %s' % self.path)
                grades.addMessage(
                    '\tApproximate search agent run-time: %1.2f' % extra_time)
                grades.addMessage(
                    '\tApproximate search agent total moves %d' % len(moves))
                ...
                grades.addMessage('FAIL: %s' % self.path)
                grades.addMessage(
                    '\tApproximate search agent code is too slow')
                return False
            ...
            grades.addMessage('FAIL: %s' % self.path)
            grades.addMessage(
                '\tApproximate search agent threw a string exception')
            return False
