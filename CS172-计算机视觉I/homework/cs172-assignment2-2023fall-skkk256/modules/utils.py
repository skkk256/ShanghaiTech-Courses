...
def build_extractor(num_layers, pretrained_path, encoder_only=False):
    encoder = networks.FeatureEncoder(num_layers, None)
    decoder = networks.FeatureDecoder(encoder.num_ch_enc)
