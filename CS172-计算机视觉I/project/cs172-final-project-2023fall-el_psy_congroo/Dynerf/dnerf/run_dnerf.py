...
from utils.loader_utils import load_blend_data
...
def train():
    ...
    if args.dataset_type == 'blender':
        images, poses, times, render_poses, render_times, hwf, i_split = load_blend_data(args.datadir, args.half_res, args.testskip)
